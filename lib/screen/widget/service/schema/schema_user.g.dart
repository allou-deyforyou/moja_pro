...
void _userSerialize(
  ...
  writer.writeDateTime(offsets[2], object.lastSign);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    lastSign: reader.readDateTimeOrNull(offsets[2]),
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSignIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'lastSign',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSignIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'lastSign',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSignEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastSign',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSignGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSignLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSignBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> relays(FilterQuery<Relay> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'relays');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> relaysLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'relays', length, true, length, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> relaysIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'relays', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> relaysIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'relays', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> relaysLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'relays', 0, true, length, include);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> relaysLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'relays', length, include, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> relaysLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByLastSign() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSign', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByLastSignDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSign', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByLastSign() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSign', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByLastSignDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSign', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByLastSign() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastSign');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, DateTime?, QQueryOperations> lastSignProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastSign');
    });
  }
